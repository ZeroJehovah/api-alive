...
func TestIndexHTMLContainsModelOrderAndStandaloneLogPanel(t *testing.T) {
	for _, want := range []string{
		...
		`viewCollapsedBeforeEdit: new Set()`,
		...
		`<span class="attempt-limit-control">`,
		`.attempt-limit-control::after`,
		`.attempt-limit-select { width: 100%; min-width: 0;`,
		...
		`function draftCollapsedGroupsFromView`,
		`function viewCollapsedGroupsFromDraft`,
